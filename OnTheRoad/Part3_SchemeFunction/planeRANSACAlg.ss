...
(define (dominantPlane Ps k eps)
  (let loop ((i 1)
    ...
    (if (= i k)
        ...
        (let* ((sup-plane (findDominOneTime Ps eps))
               (sup (car sup-plane))
...
(planeRANSAC "Point_Cloud_2_No_Road_Reduced.xyz" 0.85 0.27 0.3)
(planeRANSAC "Point_Cloud_3_No_Road_Reduced.xyz" 0.8 0.35 0.4)
